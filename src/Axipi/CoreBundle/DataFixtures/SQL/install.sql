...
(25, NULL, 'axipi_content_controller_file', 'Content / File', NULL, 'file-o', 0, 0, 0, 1, '2016-05-29 16:47:47', '2016-05-29 16:47:47', 'page', NULL, NULL),
...
(19, 2, 3, 'Test FR', 'test-fr', NULL, 'test-fr', 'title seo', 'description seo', NULL, 1, 0, '{"description":"<p>yopla<\\/p>"}', '2016-05-27 12:43:37', '2016-05-29 19:27:20', NULL, 'title social', 'description social'),
(20, 1, 26, 'Nam quis nibh quis augue pharetra malesuada', 'search', NULL, 'search', NULL, NULL, NULL, 1, 0, '{"all_languages":false,"description":"<p>test<\\/p>"}', '2016-05-29 17:32:20', '2016-05-29 19:40:47', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `widget` (
  ...
  KEY `zone_id` (`zone_id`),
  KEY `language_id` (`language_id`),
  KEY `IDX_85F91ED03D8E604F` (`parent`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
INSERT INTO `widget` (`id`, `language_id`, `component_id`, `zone_id`, `title`, `code`, `is_active`, `ordering`, `attributes`, `date_created`, `date_modified`, `template`, `parent`) VALUES
(1, 1, 4, 1, 'Footer aa', 'footer', 1, 0, '{"description":"<p><em>Morbi aliquam turpis ut dui suscipit, ut accumsan odio elementum.<\\/em><\\/p>"}', '2016-05-18 21:16:37', '2016-05-26 20:13:16', NULL, NULL),
(3, 1, 8, 3, 'Menu', 'menu', 1, 0, '{"display_title":true,"class":"aa"}', '2016-05-20 18:30:12', '2016-05-21 18:53:35', NULL, NULL),
(4, 1, 14, 4, 'Search Console', 'searchconsole', 1, 0, '{"code":"test-searchconsole"}', '2016-05-20 19:28:25', '2016-05-25 18:06:08', NULL, NULL),
(5, 1, 16, 2, 'Breadcrumbs', 'breadcrumbs', 1, 0, NULL, '2016-05-20 20:56:07', '2016-05-21 00:03:00', NULL, NULL),
(6, 1, 18, 4, 'Fav', 'fav', 1, -10, '{"image":"axipi-16x16.jpg","image_mime":"image\\/jpeg","image_size":4186}', '2016-05-23 20:08:02', '2016-05-25 19:01:35', NULL, NULL),
(7, 1, 19, 4, 'Twitter card', 'twitter-card', 1, 0, '{"site":"@axipi"}', '2016-05-25 17:22:47', '2016-05-25 17:38:09', NULL, NULL),
(8, 1, 20, 4, 'fb-opengraph', 'fb-opengraph', 1, 0, '{"site":"Axipi"}', '2016-05-25 17:31:38', '2016-05-25 17:38:18', NULL, NULL),
(9, 1, 4, 5, 'blog-aside', 'blog-aside', 1, 0, '{"description":"<h3>Welcome<\\/h3>\\r\\n<p>Aenean eleifend justo tellus, vitae lobortis leo accumsan at. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos.<\\/p>"}', '2016-05-26 19:54:38', '2016-05-26 20:06:00', NULL, NULL),
(10, 1, 23, 5, 'Categories', 'blog-categories', 1, 1, NULL, '2016-05-26 20:01:19', '2016-05-26 20:01:19', NULL, NULL),
(11, 2, 4, 1, 'footer-fr', 'footer-fr', 1, 0, '{"description":null}', '2016-05-27 14:50:27', '2016-05-27 14:50:27', NULL, NULL),
(12, 1, 27, 3, 'search', 'search', 1, 0, NULL, '2016-05-29 17:33:32', '2016-05-29 17:33:32', NULL, 20);
...
--
ALTER TABLE `widget`
  ADD CONSTRAINT `FK_85F91ED03D8E604F` FOREIGN KEY (`parent`) REFERENCES `page` (`id`) ON DELETE SET NULL,
